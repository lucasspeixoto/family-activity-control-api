...
public interface CreateBillMapper {
    ...
    CreateBillMapper INSTANCE = Mappers.getMapper(CreateBillMapper.class);

    @Mapping(target = "id", expression = "java(entity.getId() != null ? entity.getId().toString() : null)")
    //@Mapping(source = "finishAt", target = "finishAt", qualifiedByName  = "localDateToString")
    CreateBillDTO toDTO(Bill entity);
    ...
    List<CreateBillDTO> toDTOs(List<Bill> entities);

    List<Bill> toEntities(List<CreateBillDTO> dtos);
